...
Yukarıdaki datasetler incelendiğinde birinci sırada yer alan dataset ile ilgili dah fazla yayın ve çalışma bulunduğu görülmüştür. Bu nedenle [Credit Card Fraud Detection](https://www.kaggle.com/datasets/mlg-ulb/creditcardfraud/data) dataseti üzerinde çalışılması planlanmaktadır.
