...
* İnsanın göremeyeceği karşmaşık patternler (rule based olmayanlar) için veri madenciliğinden yararlanmamız gerekiyor.
...
Confidence(X => Y): 4 kişinin sepetinden pantolon alanlar ve tişört alanlar.  
Confidence(X => Y): 2 / 3
